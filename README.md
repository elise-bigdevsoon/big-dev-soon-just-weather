...
1. Start the project in our [app](https://app.bigdevsoon.me/projects/just-weather) to get a feel for it.
2. Review the requirements listed below in this README.
3. Go through the design assets on the [project's page](https://app.bigdevsoon.me/projects/just-weather) to understand the project more.
